...
import { In, Qualification, User } from '/opt/nodejs/common/help-on-spot-models/dist'
...
describe('delete organisation handler', () => {
    it('should return status 200', async () => {
        ...
        const qualifications = await connection
            .getRepository(Qualification)
            .find({ key: In(requestData.qualificationKeys) })
